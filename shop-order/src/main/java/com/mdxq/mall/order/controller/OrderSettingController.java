...
public class OrderSettingController {
     ...
     */
    @PostMapping("save")
    public boolean save(@RequestBody OrderSetting orderSetting) {
    ...
    public boolean remove(@PathVariable Long id) {
        return orderSettingService.removeById(id);
    }
     ...
     */
    @GetMapping("page")
    public Page<OrderSetting> page(Page<OrderSetting> page) {
        return orderSettingService.page(page);
    }
