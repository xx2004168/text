...
-- ----------------------------
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2a$10$ZJRkT8EaVHoLMMx7Sc3w2OmOD90ddimwiVYpLJHCTAJJ0oj/bQx8i', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2023-08-24 16:05:02', 1);
...
INSERT INTO `ums_admin` VALUES (6, 'productAdmin', '$2a$10$ZJRkT8EaVHoLMMx7Sc3w2OmOD90ddimwiVYpLJHCTAJJ0oj/bQx8i', NULL, 'product@qq.com', '商品管理员', '只有商品权限', '2020-02-07 16:15:08', NULL, 1);
INSERT INTO `ums_admin` VALUES (7, 'orderAdmin', '$2a$10$ZJRkT8EaVHoLMMx7Sc3w2OmOD90ddimwiVYpLJHCTAJJ0oj/bQx8i', NULL, 'order@qq.com', '订单管理员', '只有订单管理权限', '2020-02-07 16:15:50', '2023-02-15 14:35:20', 1);
...
INSERT INTO `ums_admin` VALUES (11, 'adminMbp', '$2a$10$VbpqK1PuDON7Zx4QXkUdpeKOHd.6nIyvXwg8jGwHZG9QjK4BCMQN2', NULL, '999999@qq.com', '超级姆巴佩', '足球总监——姆总监', '2023-02-07 11:23:10', NULL, 0);
...
CREATE TABLE `ums_admin_role_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户和角色关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台菜单表' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台资源表' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户角色表' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_role_menu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 167 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台角色菜单关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_role_resource_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 225 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台角色资源关系表' ROW_FORMAT = Compact;
