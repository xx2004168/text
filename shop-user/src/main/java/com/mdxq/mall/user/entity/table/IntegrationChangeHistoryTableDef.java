 ...
 * @since 2025-01-12
 */
public class IntegrationChangeHistoryTableDef extends TableDef {
     ...
     * 
     */
    public static final IntegrationChangeHistoryTableDef INTEGRATION_CHANGE_HISTORY = new IntegrationChangeHistoryTableDef();
    ...
    public IntegrationChangeHistoryTableDef() {
        super("md_mall_user", "ums_integration_change_history");
    }

    private IntegrationChangeHistoryTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public IntegrationChangeHistoryTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new IntegrationChangeHistoryTableDef("md_mall_user", "ums_integration_change_history", alias));
    }
